...
function IssueClient(jiraClient) {
  ...
  this.getIssueEstimation = function(opts, callback) {
    const endpoint =
      '/issue/' + (opts.issueId || opts.issueKey) + '/estimation';
    const options = {
  ...
  this.getIssue = function(opts, callback) {
    const options = opts.agile
      ? {
          uri: this.jiraClient.buildAgileURL(
            '/issue/' + (opts.issueId || opts.issueKey)
          ),
          method: 'GET',
          json: true,
          followAllRedirects: true,
      ...
      : this.buildRequestOptions(opts, '', 'GET');
  ...
  this.deleteIssue = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '', 'DELETE', null, {
  ...
  this.assignIssue = function(opts, callback) {
    const assigneeIdOrName = opts.accountId || opts.assignee;
    if (
      !(
        (typeof assigneeIdOrName === 'string' && assigneeIdOrName.length) ||
        assigneeIdOrName === null
      )
    ) {
      throw new Error(errorStrings.NO_ASSIGNEE_ERROR);
    }
    const params = opts.accountId
      ? { accountId: opts.accountId }
      : { name: opts.assignee };
    const options = this.buildRequestOptions(opts, '/assignee', 'PUT', params);
  ...
  this.getComments = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/comment', 'GET');
  ...
  this.addComment = function(opts, callback) {
    const options = {
      uri: this.jiraClient.buildURL(
        '/issue/' + (opts.issueId || opts.issueKey) + '/comment'
      ),
      method: 'POST',
      json: true,
      followAllRedirects: true,
  ...
  this.getEditMetadata = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/editmeta', 'GET');
  ...
  this.getRemoteLinks = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/remotelink', 'GET', null, {
  ...
  this.unvote = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/votes', 'DELETE');
  ...
  this.vote = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/votes', 'POST');
  ...
  this.getVotes = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/votes', 'GET');
  ...
  this.getChangelog = function(opts, callback) {
    const endpoint = '/issue/' + (opts.issueId || opts.issueKey) + '/changelog';
    const options = {
  ...
  this.getWatchers = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/watchers', 'GET');
  ...
  this.getWorkLogs = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/worklog', 'GET');
  ...
  this.addWorkLog = function(opts, callback) {
    const options = {
      uri: this.jiraClient.buildURL(
        '/issue/' + (opts.issueId || opts.issueKey) + '/worklog'
      ),
      method: 'POST',
      json: true,
      followAllRedirects: true,
  ...
  this.addAttachment = function(opts, callback) {
    const filename = Array.isArray(opts.filename)
      ? opts.filename
      : [opts.filename];
    const attachments = filename.map(filePath => {
    ...
    const options = {
      uri: this.jiraClient.buildURL(
        '/issue/' + (opts.issueId || opts.issueKey) + '/attachments'
      ),
      method: 'POST',
      json: true,
      followAllRedirects: true,
  ...
  this.getProperties = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/properties', 'GET');
  ...
  this.buildRequestOptions = function(opts, path, method, body, qs) {
    ...
    const idOrKey = opts.issueId || opts.issueKey;
    const basePath = '/issue/' + idOrKey;
    if (!qs) {
      qs = {};
    }
    if (!body) {
