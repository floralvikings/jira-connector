...
function FilterClient(jiraClient) {
  ...
  this.updateFilter = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '', 'PUT', opts.filter);
  ...
  this.getFilterColumns = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/columns', 'GET');
  ...
  this.setFilterColumns = function(opts, callback) {
    const body = { columns: opts.columns };
    const options = this.buildRequestOptions(opts, '/columns', 'PUT', body);
  ...
  this.resetFilterColumns = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/columns', 'DELETE');
  ...
  this.buildRequestOptions = function(opts, path, method, body, qs) {
    const basePath = '/filter/' + opts.filterId;
    if (!qs) {
      qs = {};
    }
    if (!body) {
