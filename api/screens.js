...
function ScreensClient(jiraClient) {
  ...
  this.getAvailableFields = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/availableFields', 'GET');
  ...
  this.getTabs = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/tabs', 'GET');
  ...
  this.createTab = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/tabs', 'POST', {
      name: opts.name
    });
  ...
  this.removeFieldFromTab = function(opts, callback) {
    const options = this.buildRequestOptions(
      opts,
      '/tabs/' + opts.tabId + '/fields/' + opts.fieldId,
      'DELETE'
    );
  ...
  this.moveFieldOnTab = function(opts, callback) {
    const options = this.buildRequestOptions(
      opts,
      '/tabs/' + opts.tabId + '/fields/' + opts.fieldId + '/move',
      'POST',
  ...
  this.moveTabPosition = function(opts, callback) {
    const options = this.buildRequestOptions(
      opts,
      '/tabs/' + opts.tabId + '/move/' + opts.newPosition,
      'POST'
    );
   ...
   * @returns {{uri: string, method: string, body: Object, innerQs: Object, followAllRedirects: boolean, json: boolean}}
   */
  this.buildRequestOptions = function(opts, path, method, body, qs) {
    const basePath = '/screens/' + opts.screenId;
    const innerQs = qs || {};

    if (opts.fields) {
      innerQs.fields = '';
      opts.fields.forEach(field => {
        innerQs.fields += field + ',';
      });
      innerQs.fields = innerQs.fields.slice(0, -1);
    }
    ...
    if (opts.expand) {
      ...
      innerQs.expand = innerQs.expand.slice(0, -1);
    }
