...
function ProjectClient(jiraClient) {
  ...
  this.getProject = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '', 'GET');
  ...
  this.getComponents = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/components', 'GET');
  ...
  this.getStatuses = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/statuses', 'GET');
  ...
  this.getVersions = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/versions', 'GET');
  ...
  this.getVersionsPaginated = function(opts, callback) {
    ...
    const options = this.buildRequestOptions(opts, '/version', 'GET', {}, qs);
  ...
  this.getRoles = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/role', 'GET');
  ...
  this.buildRequestOptions = function(opts, path, method, body, qs) {
    ...
    const basePath = opts.projectIdOrKey
      ? '/project/' + opts.projectIdOrKey
      : '/project';
