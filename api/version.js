...
function VersionClient(jiraClient) {
  ...
  this.moveVersion = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/move', 'POST', {
  ...
  this.editVersion = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '', 'PUT', opts.version);
  ...
  this.getRemoteLinks = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/remotelink', 'GET');
  ...
  this.deleteAllRemoteLinks = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/remotelink', 'DELETE');

    return this.jiraClient.makeRequest(
      options,
      callback,
      'Remote Links Deleted'
    );
  };
  ...
  this.buildRequestOptions = function(opts, path, method, body, qs) {
    const basePath = '/version/' + opts.versionId;
    if (!qs) {
      qs = {};
    }
    if (!body) {
