...
function WorkflowSchemeClient(jiraClient) {
  ...
  this.getWorkflowScheme = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '', 'GET', null, {
  ...
  this.deleteWorkflowScheme = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '', 'DELETE');

    return this.jiraClient.makeRequest(
      options,
      callback,
  ...
  this.createDraft = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/createdraft', 'POST');
  ...
  this.getDefaultWorkflow = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/default', 'GET', null, {
      returnDraftIfExists: opts.returnDraftIfExists
    });
  ...
  this.removeDefaultWorkflow = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/default', 'DELETE', null, {
  ...
  this.setDefaultWorkflow = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/default', 'PUT', {
  ...
  this.getDraft = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/draft', 'GET');
  ...
  this.editDraft = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/draft', 'PUT', opts.draft);
  ...
  this.deleteDraft = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/draft', 'DELETE');
  ...
  this.getDraftDefaultWorkflow = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/draft/default', 'GET');
  ...
  this.setDraftDefaultWorkflow = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/draft/default', 'PUT', {
      workflow: opts.workflowName,
      updateDraftIfNeeded: opts.updateDraftIfNeeded
    });
  ...
  this.removeDraftDefaultWorkflow = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/draft/default', 'DELETE');
  ...
  this.getDraftIssueType = function(opts, callback) {
    const options = this.buildRequestOptions(
      opts,
      '/draft/issuetype/' + opts.issueType,
      'GET'
    );
  ...
  this.getWorkflow = function(opts, callback) {
    const options = this.buildRequestOptions(opts, '/workflow', 'GET', null, {
  ...
  this.buildRequestOptions = function(opts, path, method, body, qs) {
    const basePath = '/workflowscheme/' + opts.workflowSchemeId;
    if (!qs) {
      qs = {};
    }
    if (!body) {
