...
function AgileEpicClient(jiraClient) {
  ...
  this.getIssuesWithoutEpic = function(opts, callback) {
    const endpoint = this.jiraClient.buildAgileURL('/epic/none/issue');
    opts = opts || {};
  ...
  this.getEpic = function(opts, callback) {
    const endpoint = this.jiraClient.buildAgileURL('/epic/' + opts.epicId);
  ...
  this.moveIssuesToEpic = function(opts, callback) {
    const endpoint = this.jiraClient.buildAgileURL(
      '/epic/' + opts.epicId + '/issue'
    );
